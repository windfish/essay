 ...
 * <pre>
 * 第四章  线程执行器
 * Test_4_2  线程执行器 TreadPoolExecutor，创建缓存线程池
 * Test_4_3  创建固定大小的线程池
 * Test_4_4  线程执行器返回运行结果 Callable、Future
 * Test_4_5  运行多个任务并处理第一个结果  ExecutorService.invokeAny()
 ...
 * Test_4_11 执行器中分离任务的启动和结果的处理  CompletionService 类的submit和poll
 * Test_4_12 处理在执行器中被拒绝的任务  
 * </pre>
 */
